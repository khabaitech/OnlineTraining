...
$nam=mysql_real_escape_string($_POST['racloc']);
$msg = $obj->set_rac($id,$nam); 
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
      ...
      <div class="grid_12">
                ...
                <div class="module1">
                     <h2><font size="5"><span>|| Add New Rack ||</span></font></h2>
                  ...
                  <?php 
				   ...
				   {
				   ?>
                   <span class="notification n-success">Add New Rack Successfully.......!!</span>
                   <?php
                   }
				   ?>   
      <form name="add_wri" action="" method="post">
          ...
          <table width="100%">
          <tr>
            <td width="326" height="65" align="right">Rack No. : </td>
            <td width="553" align="left">
            <input type="text" name="rid" id="rid" value="<?php echo $obj->get_id("rack");?>" class="input-medium" readonly="readonly"/><label>
            </label></td>
            </tr>
          
          <tr>
            <td height="65" align="right">Rack Location : </td>
            <td align="left"><input type="text" name="racloc" id="racloc" class="input-medium" />
              <label id="user"></label>
            </td>
          </tr>
         <tr>
